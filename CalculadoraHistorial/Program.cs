...
while (bandera == 1)
{
    ...
    switch (opcion)
    {
        ...
        default:
            ...
            TipoOperacion.TryParse(entrada, out Operaciones);
            ...
            {
                operaciones.Add(new Operacion(0, nuevoValor, Operaciones));
            }
            else
            {
                ...
                operaciones.Add(new Operacion(resultadoAnterior, nuevoValor, Operaciones));
                i++;
                Console.WriteLine($"La {operaciones[i].Operaciones} de {operaciones[i].ResultadoAnterior} y {operaciones[i].NuevoValor} es {operaciones[i].Resultado()}");
            }
            break;
    }
